...
namespace GoldenChicken.Infrastructure.Helpers
{
    public class Email
    {
        ...
        public static async Task SendEmail(EmailFormModel emailForm)
        {
            ...
            message.From = new MailAddress("GoldenChickenWayTeam@gmail.com");  // replace with valid value
            ...
            using (var smtp = new SmtpClient())
            {
                ...
                {
                    UserName = "GoldenChickenWayTeam@gmail.com", // replace with valid value
