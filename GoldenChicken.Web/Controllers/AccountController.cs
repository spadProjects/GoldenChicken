...
namespace GoldenChicken.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new GoldenChicken.Web.Models.ApplicationUser { UserName = model.Email, Email = model.Email };
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    FromName = "GoldenChicken Way Team",
                    FromEmail = "GoldenChickenWayTeam@gmail.com",
                    ToEmail = user.Email,
